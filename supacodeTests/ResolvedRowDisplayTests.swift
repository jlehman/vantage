...
struct ResolvedRowDisplayTests {
  ...
  @Test func highlightTrailIsDefaultForMainWorktree() {
    let resolved = ResolvedRowDisplay(
      ...
      hideSubtitle: false,
      hideSubtitleOnMatch: true,
      highlightSubtitle: SidebarHighlightRepoTag(repoName: "vantage", repoColor: .blue, hostInfo: nil)
    )
  ...
  @Test func highlightTrailHidesOnMatchWhenFlagOn() {
    let resolved = ResolvedRowDisplay(
      ...
      hideSubtitle: false,
      hideSubtitleOnMatch: true,
      highlightSubtitle: SidebarHighlightRepoTag(repoName: "vantage", repoColor: nil, hostInfo: nil)
    )
