...
struct ZmxClient: Sendable {
  ...
  /// Returns each live Vantage session with its attached-client count, or nil
...
nonisolated enum ZmxAttach {
  ...
  /// agent hook's in-band presence OSC is gated to a Vantage surface, see
  ...
  static let betaBanner =
    #"printf '\033[2m── Remote Vantage surfaces are in beta and may have reduced functionality. ──\033[0m\r\n'; "#
}
