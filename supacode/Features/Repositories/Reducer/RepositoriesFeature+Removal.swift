...
extension RepositoriesFeature {
  ...
  /// are repo-level and drop the whole section from Vantage, with
...
extension RepositoriesFeature {
  ...
  func confirmationAlertForRepositoryRemoval(
    ...
    return AlertState {
      ...
      TextState(
        isGitRepository
          ? "This removes the repository from Vantage. "
            + "The repository and its worktrees stay on disk."
          : "This removes the folder from Vantage. The folder stays on disk."
      )
    }
  }
