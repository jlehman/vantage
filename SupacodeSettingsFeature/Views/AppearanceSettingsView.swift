    ...
    Form {
      ...
      Section {
        Toggle(isOn: $store.analyticsEnabled) {
          ...
          Text("Anonymous usage data helps improve Vantage.")
        }
        ...
        Text("Changes to Analytics require Vantage to restart before they take effect.")
      }
      Section("Advanced") {
